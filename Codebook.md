#Data Structure
averageByGroup.csv contains a total 180 \(30 subjects and 6 activities) observations of 79 averaged features \(features that are mean or standard deviation for each original measurement\).

#Rows:
Each row corresponds to one subject+activity combination.

#Colum names and values: 
### subjectID :  
